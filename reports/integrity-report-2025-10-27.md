...
**Generated**: 2025-10-27T03:31:56.608Z
...
- **Branch**: `develop`
- **Commit**: `04349101ebfe766cf1549dd230596de423615201`
- **Commit Date**: 2025-10-27 03:16:47 +0000
- **Last Commit**: chore: Update integrity reports
- **Author**: hellel
...
| Build Process | ❌ FAILED | N/A | [06-build.log](integrity-logs/06-build.log) |
...
| SDK Tests | ❌ FAILED | N/A | [11-sdk-tests.log](integrity-logs/11-sdk-tests.log) |
...
- **Status**: PARTIAL
- **Duration**: N/A
- **Log**: [01-dependency-install.log](integrity-logs/01-dependency-install.log) (3.62 KB)
...
- **Status**: FAILED
- **Duration**: N/A
- **Log**: [04-typecheck.log](integrity-logs/04-typecheck.log) (1.88 KB)

**Errors/Warnings**:
```
packages/sw typecheck: src/sw.ts(15,139): error TS2344: Type '"isEdited" | "editCount" | "latestEditedAt"' does not satisfy the constraint '"emojis" | "reply" | "renote" | "text" | "id" | "renoteId" | "replyId" | "cw" | "files" | "fileIds" | "poll" | "createdAt" | "updatedAt" | "deletedAt" | "userId" | "user" | "isHidden" | ... 18 more ... | "myReaction"'.
packages/sw typecheck: src/sw.ts(19,5): error TS2353: Object literal may only specify known properties, and 'isEdited' does not exist in type '{ id: string; createdAt: string; updatedAt?: string | null | undefined; deletedAt?: string | null | undefined; text: string | null; cw?: string | null | undefined; userId: string; user: { id: string; ... 14 more ...; badgeRoles?: { ...; }[] | undefined; }; ... 27 more ...; myReaction?: string | ... 1 more ... | unde...'.
packages/sw typecheck: Failed
ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  sw@ typecheck: `tsc --noEmit`
```
...
- **Status**: FAILED
- **Duration**: N/A
- **Log**: [05-lint.log](integrity-logs/05-lint.log) (3.84 KB)

**Errors/Warnings**:
```
packages/sw lint: src/sw.ts(15,139): error TS2344: Type '"isEdited" | "editCount" | "latestEditedAt"' does not satisfy the constraint '"emojis" | "reply" | "renote" | "text" | "id" | "renoteId" | "replyId" | "cw" | "files" | "fileIds" | "poll" | "createdAt" | "updatedAt" | "deletedAt" | "userId" | "user" | "isHidden" | ... 18 more ... | "myReaction"'.
packages/sw lint: src/sw.ts(19,5): error TS2353: Object literal may only specify known properties, and 'isEdited' does not exist in type '{ id: string; createdAt: string; updatedAt?: string | null | undefined; deletedAt?: string | null | undefined; text: string | null; cw?: string | null | undefined; userId: string; user: { id: string; ... 14 more ...; badgeRoles?: { ...; }[] | undefined; }; ... 27 more ...; myReaction?: string | ... 1 more ... | unde...'.
packages/sw lint:  ELIFECYCLE  Command failed with exit code 2.
packages/sw lint: Failed
...
- **Status**: FAILED
- **Duration**: N/A
- **Log**: [06-build.log](integrity-logs/06-build.log) (1.49 KB)

**Errors/Warnings**:
```
packages/icons-subsetter build: [icons-subsetter] TypeError: Cannot read properties of undefined (reading 'memory')
packages/icons-subsetter build: Failed
ERR_PNPM_RECURSIVE_RUN_FIRST_FAIL  icons-subsetter@0.0.0 build: `tsx src/generator.ts`
...
- **Status**: FAILED
- **Duration**: N/A
- **Log**: [11-sdk-tests.log](integrity-logs/11-sdk-tests.log) (2.03 KB)
...
- **Status**: PARTIAL
- **Duration**: N/A
- **Log**: [00-environment.log](integrity-logs/00-environment.log) (631 B)

### ❌ 09-backend-unit-tests

- **Status**: FAILED
- **Duration**: N/A
- **Log**: [09-backend-unit-tests.log](integrity-logs/09-backend-unit-tests.log) (1.21 MB)

**Errors/Warnings**:
```
FAIL test/unit/server/api/drive/files/create.ts
● Test suite failed to run
FAIL test/unit/queue/processors/CleanRemoteNotesProcessorService.ts (82 MB heap size)
Error: connect ECONNREFUSED 127.0.0.1:54312
...
2. **Failed Checks**: The following checks failed and require immediate attention:
   ...
   - Linting - See [05-lint.log](integrity-logs/05-lint.log)
     - packages/sw lint: src/sw.ts(15,139): error TS2344: Type '"isEdited" | "editCount" | "latestEditedAt"' does not satisfy the constraint '"emojis" | "reply" | "renote" | "text" | "id" | "renoteId" | "replyId" | "cw" | "files" | "fileIds" | "poll" | "createdAt" | "updatedAt" | "deletedAt" | "userId" | "user" | "isHidden" | ... 18 more ... | "myReaction"'.
   - Build Process - See [06-build.log](integrity-logs/06-build.log)
     - packages/icons-subsetter build: [icons-subsetter] TypeError: Cannot read properties of undefined (reading 'memory')
   ...
   - Frontend Tests - See [10-frontend-tests.log](integrity-logs/10-frontend-tests.log)
     - Error: connect ECONNREFUSED 127.0.0.1:3000
   - SDK Tests - See [11-sdk-tests.log](integrity-logs/11-sdk-tests.log)
     - ELIFECYCLE  Command failed with exit code 1.
...
- [00-environment.log](integrity-logs/00-environment.log) (631 B)
- [01-dependency-install.log](integrity-logs/01-dependency-install.log) (3.62 KB)
- [02-pnpm-audit.log](integrity-logs/02-pnpm-audit.log) (0 B)
- [03-pnpm-doctor.log](integrity-logs/03-pnpm-doctor.log) (0 B)
- [04-typecheck.log](integrity-logs/04-typecheck.log) (1.88 KB)
- [05-lint.log](integrity-logs/05-lint.log) (3.84 KB)
- [06-build.log](integrity-logs/06-build.log) (1.49 KB)
- [07-connectivity.log](integrity-logs/07-connectivity.log) (139 B)
- [08-migrations.log](integrity-logs/08-migrations.log) (33 B)
- [09-backend-unit-tests.log](integrity-logs/09-backend-unit-tests.log) (1.21 MB)
- [10-frontend-tests.log](integrity-logs/10-frontend-tests.log) (23.01 KB)
- [11-sdk-tests.log](integrity-logs/11-sdk-tests.log) (2.03 KB)
...
The repository has 8 failed check(s) that require attention before deployment.
